...
class _WordDetailScreenState extends ConsumerState<WordDetailScreen> {
  Word? _savedOnlineWord;
  bool _isSaving = false;

  @override
  Widget build(BuildContext context) {
    if (widget.initialWord != null && (widget.initialWord!.isOnline || widget.wordId <= 0)) {
      final currentWord = _savedOnlineWord ?? widget.initialWord!;
      return _buildContent(context, currentWord);
    }

    final wordAsync = ref.watch(wordDetailProvider(widget.wordId));
    return wordAsync.when(
      data: (word) => _buildContent(context, word),
      ...
      error: (err, _) => Scaffold(
        ...
        body: ErrorStateView(
          ...
          onRetry: () => ref.invalidate(wordDetailProvider(widget.wordId)),
        ),
      ),
    );
  }

  Widget _buildContent(BuildContext context, Word word) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Online Result Notification Banner
            if (word.isOnline) ...[
              Container(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Fetched from online dictionary & translation service. Save to access offline.',
                            style: TextStyle(
                              fontSize: 11.5,
            ...
            Row(
              ...
              children: [
                ...
                AudioPronounceButton(
                  id: 'detail_meaning_${word.id}_${word.word}',
                  text: word.meaning,
            ...
            Row(
              ...
              children: [
                ...
                if (word.example.isNotEmpty)
                  AudioPronounceButton(
                    id: 'detail_example_${word.id}_${word.word}',
                    text: word.example,
            ...
            // Action Button: Save to Vocabulary (if online) or Mastered (if saved)
            if (word.isOnline) ...[
              SizedBox(
                width: double.infinity,
